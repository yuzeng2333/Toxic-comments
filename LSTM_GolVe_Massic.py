...
TEST_LABEL_FILE='./submission_LR.csv'
...
list_sentences_train = np.hstack((list_sentences_train, list_sentences_test))
...
sample_submission.to_csv('submission_LSTM_GloVe_clean_all.csv', index=False)
